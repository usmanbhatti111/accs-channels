    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'accounts') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                ...
                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'charts') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                    <a href="{{ route('charts.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">Chart Data</span>
                    </a>
                </li>
