        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            ...
            <div class="card-toolbar">
              ...
              <a href="{{ route('charts.index') }}" class="btn btn-light-primary
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('date') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        {{ Form::date('date', null, ['class' => 'form-control form-control-solid','id'=>'date','placeholder'=>'Enter Date','required'=>'true']) }}
                    ...
                    <div class="form-group row {{ $errors->has('value') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        {{ Form::text('value', null, ['class' => 'form-control form-control-solid','id'=>'value','placeholder'=>'Email value','required'=>'true']) }}
