        ...
        <div class="like_table">
            <div class="table_cell">
                <div class="modal-block__content modal-block__content--info">
                    ...
                    <div class="modal-block__title">Identity verification</div>
                    <p>In order to verify your identity, we'll need to process your passport or ID card photo, together with a video of your face. This verification happens automatically and only takes 1-3 minutes. Once the verification has been successfully completed, you'll be given the "Verified Person" status, which will help your customers trust you more and boost your sales compared to unverified sellers. You will receive +1000 to the rating or + 2000 / + 4000, if you have a pro / vip account. We'll place a badge on both your profile and your listings that confirms that you’re a verified person. When you purchase VIP status, in addition to the benefits listed above, you will also receive a discounted commission fee of 6% instead of 7%, and we’ll place a special status on both your profile and your listings that notes “Deals with this user are for a 6% fee”.</p>
                    <p>The verification and storage of your data is handled by a third party service called Sum&Substance, which is the official registered agent for the processing of personal data. All data we collect for processing is transferred using TLS 1.2 encryption and subsequently stored in an encrypted format in a secure data center, which conforms to the Tier III standard for reliability and denial of service resistance as codified by the Uptime Institute. It also conforms to the TIA-942 standard and has a PCI DSS certificate. Your data will be safe, and will only be released if there is a request from law enforcement if you have engaged in fraudulent behavior.</p>
    ...
    <div id="modal9" class="modal-block modal fade">
        <div class="like_table">
            <div class="table_cell">
                                    ...
                                    <div>
                                        <div class="modal-block__service-select width1">
                                            ...
                                            <select name="group" style="width: 100%">
                                                <option value="214302">Cryptoverse</option>
                                                <option value="213455">LQ plus</option>
                                                <option value="214045">Daily Suli</option>
                                                <option value="214469">Cricket World</option>
                                                <option value="214460">Ahmad 4XO</option>
                                                <option value="214301">Crypto World</option>
                                                <option value="214455">Crypto ARK</option>
                                                <option value="213728">يوميات صباح</option>
                                                <option value="214426">HappyGame</option>
                                                <option value="214412">Crypto Infinity</option>
                                                <option value="212977">Hellish</option>
                                                <option value="213660">Aman&#039;s Desi Adventure</option>
                                                <option value="214404">xxXEmilyEnvyXxxx</option>
                                                <option value="214361">ECO Fact</option>
                                                <option value="214090">Aviator</option>
                                                <option value="213517">Tyzik</option>
                                                <option value="213846">BeamNG Vali</option>
                                                <option value="213917">VFX Angati Train </option>
                                                <option value="214135">Зазедка - Лайф</option>
                                                <option value="214137">Kids Draw TV</option>
                                                <option value="214142">Ocelot Craft</option>
                                                <option value="214230">XP</option>
                                                <option value="205959">Владюша</option>
                                                <option value="214263">Handmade World</option>
                                                <option value="214181">STARTUP BUSINESS</option>
                                                <option value="214158">Ome Taha </option>
                                                <option value="213342">Perfect Time</option>
                                                <option value="214121">33Grafix</option>
                                                <option value="212877">WINTER SHOW</option>
                                                <option value="214102">CoinMarketCap - News</option>
                                                <option value="214101">CoinMarketCap - News</option>
                                                <option value="214068">Gaming X</option>
                                            </select>
                                        </div>
...
<div id="modal-container">
            ...
            <div class="like_table">
                <div class="table_cell">
                    <div class="modal-block__content modal-block__content--form"><a href="#" data-dismiss="modal" class="modal-close"></a>
                        ...
                        <form id="js-login-form" method="POST" action="">
    ...
    <div id="modal3" class="modal-block modal fade">
        <div class="like_table">
            <div class="table_cell">
                <div class="modal-block__content modal-block__content--data"><a href="#" data-dismiss="modal" class="modal-close"></a>
                    <div class="modal-block__title">Send request to seller
                    </div>
                    <form>
                        <div class="modal-checkbox">
                            <input type="checkbox" checked="checked" name="use_guard" id="g1">
                            <label for="g1" class="use-safe-deal-label">Use the safe transaction escrow service</label>
                            <label for="g1" class="mobile use-safe-deal-label">Safe transaction</label>
                        </div>
                        <div class="modal-textarea">
                            <textarea name="message" placeholder="Message to the seller"></textarea>
                        </div>
                        <div id="use-garant-or-not">
                            <div id="choose-payment-methods-boxes">
                                ...
                                <ul>
                                    ...
                                    <li data-id="9"><img src="images/payments/messenger.png" alt="Facebook Pay"></li>
                                    ...
                                    <li data-id="12"><img src="images/payments/walmart.png" alt="Walmart"></li>
                                </ul>
                            </div>
                            ...
                            <div class="transfer-phone group" data-type="0">
                                ...
                                <div class="transfer-phone__input" style="margin-top: -8px;">
                                    <input type="tel" name="phone" placeholder="Enter your email">
                                </div>
                            </div>
                        </div>
        ...
        <div class="like_table">
            <div class="table_cell">
                <div class="modal-block__content modal-block__content--info"><a href="#" data-dismiss="modal" class="modal-close"></a>
                    ...
                    <form action="https://accs-market.com/delete/group" method="POST">
                        <input type="hidden" name="_token" value="myRqfaMyhL2FRG9jaMFQ0fslcQBo8HwH4iPBXMzU">
                    ...
                    <div class="payment-row">
                        <div class='deal-comment__select'>
                            <select name="payment-method">
                                <option value='13'>Visa/MasterCard (including USA, Canada)</option>
            ...
            <div class="table_cell">
                <div class="modal-block__content modal-block__content--info"><a href="#" data-dismiss="modal" class="modal-close"></a>
                    ...
                    <form>
                        ...
                        <textarea style="display: none;" name="group_reason" class="form-control" placeholder="Specify the reason for banning the page"></textarea>
                        <label>
                        ...
                        <div class="ban-options-container">
                            ...
                            <label>
                                <input type="checkbox" name="nick_filter">
                                Ban their username
                            </label>
                            <label>
                                <input type="checkbox" name="groups_filter">
                                Ban all of their pages
                            </label>
                        </div>
                        <div class="modal-buttons">
                            <input type="submit" value="Yes">
    ...
    <div id="modal15" class="modal-block modal fade">
        <div class="like_table">
            <div class="table_cell">
                <div class="modal-block__content modal-block__content--info"><a href="#" data-dismiss="modal" class="modal-close"></a>
                    <div class="modal-block__title">Are you sure you want to block this user?</div>
                    <form>
                        <input type="hidden" name="id" value="">
                        <textarea class="form-control" placeholder="Explain why you blocked it" name="reason"></textarea>
                        <label>
    ...
    <div id="modal16" class="modal-block modal fade">
        <div class="like_table">
            <div class="table_cell">
                <div class="modal-block__content modal-block__content--data"><a href="#" data-dismiss="modal" class="modal-close"></a>
                    <div class="modal-block__title">Please confirm that you’re the page’s owner</div>
                ...
                <div class="modal-block__content modal-block__content--data">
                    <div class="policy-container">
                        ...
                        <div class="garant-terms-text">
                            ...
                            <p>Please read these Terms of Use (“Terms”, “Terms of Use”) carefully before using the <a href="index.html">Accs-market.com</a> website (the “Service”).</p>
                            ...
                            <h3>Privacy</h3>
                            <p>Please read our <a href="privacy/index.html">Privacy Policy</a> for a better understanding of data which Accs-market stores.</p>
                            ...
                            <h3>Contact Us</h3>
                            <p>Please <a href="">contact us</a> if you have any questions about these Terms.</p>
                        </div>
                    </div>
                    <div class="garant-terms-warning">
                        <i class="fa fa-warning"></i>
                        <p>ATTENTION! <b>Accs-market is not responsible for what happens after the listing ends or after the completion of sales. A sale ends when the Seller has received the payment from the Buyer.</b>
